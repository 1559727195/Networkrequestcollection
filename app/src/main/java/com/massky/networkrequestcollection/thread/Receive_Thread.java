package com.massky.networkrequestcollection.thread;
...
import static com.massky.networkrequestcollection.util.AES.Decrypt;
import static com.massky.networkrequestcollection.util.UDPClient.udp_client_destroy;
...
public class Receive_Thread implements Runnable//实现Runnable
{
    ...
    public Receive_Thread(final Socket clientSocket, Context _instance, ICallback iCallback) {
